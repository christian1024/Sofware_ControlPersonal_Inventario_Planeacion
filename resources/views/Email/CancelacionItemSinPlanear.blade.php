...
<div class="col-lg-12">
    <div class="col-lg-12">
        <p>Buen Dia</p>
        <p>Se canceló el siguiente Item Interno del pedido <b> {{ $CabezaPedido->NumeroPedido }}</b> para el cliente <b> {{ $CabezaPedido->Nombre }} </b></p>
    </div>
    <div class="col-lg-8">
        <table class="table table-striped">
            ...
            @foreach($DetallePedido as $pe)
                <tr>
                    ...
                    <td>{{ $pe->id }}</td>
                    <td>{{ $pe->ObservacionCancelacion }}</td>
                </tr>
            @endforeach
            </tbody>
        </table>
