...
@section('contenidoPrincipal')
    ...
    <div class="card">
        <h4 class="card-header text-center">Ficha tecnica Generos Pruebas</h4>
        <div class="card-body">
            <table class="table table-bordered" id="TableTickets">
                ...
                <tbody>
                @foreach($fichatecnica  as $dato)
                    <tr>
                        <td>{{ $dato->NombreGenero }}</td>
                        ...
                        <td class="text-center">
                            <button class="btn btn-success btn-circle btn-sm" type="button" data-toggle="modal" data-target="#UpdateItem" data-whatever="{{ json_encode($dato) }}" style="position: center">
