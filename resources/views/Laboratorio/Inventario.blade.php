...
@section('contenidoPrincipal')
    ...
    <div class="card row">
        ...
        <div class="">
            <ul class="nav nav-tabs">
                ...
                <li>
                    <a class="nav-link" id="home-tab1" data-toggle="tab" role="tab" aria-controls="home" aria-selected="true" href="#ReporteDinamicoFecha">Reporte Dinamico Fecha</a>
                </li>
                <li>
                    <a class="nav-link" id="home-tab2" data-toggle="tab" role="tab" aria-controls="home" aria-selected="true" href="#ReporteDinamicoVariedades">Reporte Dinamico Variedades</a>
                </li>
            </ul>
            <div class="tab-content">
                ...
                <div id="ReporteEstandar" class="card tab-pane fade show active" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <div class="card-body news">
                        <div class="form-row">
                            ...
                            <div class="col-lg-3">
                                <a href="{{ route('DescargaInventario')}}" class="btn btn-success fa fa-cloud-download">
                                    <i data-toggle="tooltip" title="Descargar Inventario Activo"> Descargar Inventario Activo</i>
                                </a>
                            </div>
                            <div class="col-lg-3">
                                <a href="{{ route('DescargaInventarioTotal')}}" class="btn btn-success fa fa-cloud-download">
                                    <i data-toggle="tooltip" title="Descargar Inventario Total"> Descargar Inventario Total</i>
                                </a>
                            </div>
                                    ...
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-body form-row" style="display: none" id="diventrada">
                                            ...
                                            <div class="col-lg-12 text-center">
                                                <form id="Fechas" method="POST" action="{{ route('ReporteEntradaLab') }}">
                                                    ...
                                                    <button id="btnEntradas" type="submit" class="btn-lg btn-block btn btn-outline-primary">Cargar</button>
                                                </form>
                                            </div>
                                        </div>
                                        ...
                                        <div class="panel-body form-row" style="display: none" id="divsalidad">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="col-lg-12">
                                                    <label class="checkbox-inline">
                                                        <input type="checkbox" name="lectSalida" class="custom-switch-input" id="SemanaSalidaD"> Fecha Salida
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12 text-center">
                                                <form id="ReporteSalidas" method="POST" action="{{ route('ReporteSalidaLab') }}">
                                                    <input type="hidden" value="{{ csrf_token() }}" name="_token" id="token">
                                                    <button id="btnSalidas" type="submit" class="btn-lg btn-block btn btn-outline-primary">Cargar</button>
                                                </form>
                                            </div>
                                        </div>
                    ...
                    <div class="col-lg-12 box box-primary">
                        <div class="">
                            <div>
                                <div class="col-lg-12">
                                    <div class="">
                                        <div>
                                            ...
                                            <input type="date" name="FechaFinDinamico" id="FechaFinDinamico" class="labelform" required="required">


                                            {{--<button id="btnEntradasDinamico" type="button" class="btn btn-success btn-xs btn-block"></button>--}}
                                            <a class="btn btn-success fa fa-sign-out" id="btnEntradasDinamicoFecha">
                                                <i data-toggle="tooltip" title="Reporte entradas"> Entradas Tiempo real</i>
                                            </a>

                                            <a class="btn btn-success fa fa-sign-out" id="btnEntradasDinamicoFechaN">
                                                <i data-toggle="tooltip" title="Reporte entradas"> Entradas</i>
                                            </a>

                                            <a class="btn btn-success fa fa-sign-out" id="btnSalidasDinamicoFecha">
                                ...
                                <div class="col-lg-12 Entrada" id="a">
                                    <div id="ReporteDinamicoEntradasFecha" style="display: none"></div>
                                    <div id="ReporteDinamicoEntradasFechaN" style="display: none"></div>
                                    <div id="ReporteDinamicoSalidasFecha" style="display: none"></div>
                ...
                <div id="ReporteDinamicoVariedades" class="tab-pane fade show" role="tabpanel" aria-labelledby="home-tab">
                    <div class="col-lg-12 box box-primary">
                        <div class="">
                            <div>
                                <div class="col-lg-12">
                                    ...
                                    <div class="">
                                        <div>
                                            ...
                                            <label for="" class="control-label">{{ __('Fecha Fin ') }}</label>
                                            <input type="date" name="FechaFinDinamicoA" id="FechaFinDinamicoF" class="labelform" required="required">
                                            ...
                                            <a class="btn btn-success fa fa-sign-out" id="btnSalidasDinamico">
                                                <i data-toggle="tooltip" title="Reporte Salidas"> Salidas</i>
                                            </a>

                                            <a class="btn btn-success fa fa-long-arrow-down" id="btnDespunteDinamico">
                                                <i data-toggle="tooltip" title="Reporte Despunte"> Despunte</i>
                                            </a>
                                ...
                                <div class="col-lg-12 Entrada">
                                    ...
                                    <div id="ReporteDinamicoDespuntes" style="display: none"></div>
                                    <div id="loading" style="position: absolute; left: 50%;">
                                    </div>
                                </div>
        ...
        <div class="container-fluid">
            <div class="card-body" style="display: none" id="tablaReporteEntrada">
    ...
    <script>
        window.onload = function () {
            ...
            document.getElementById('FechaFinDinamico').value = ano + "-" + mes + "-" + dia;
            document.getElementById('FechaFinDinamicoF').value = ano + "-" + mes + "-" + dia;
        };
        $(function () {
        ...
        $(document).ready(function () {
                        ...
                        success: function (Result) {
                            ...
                            var TableReporSa = $('#TablaReporteSalidas').DataTable({
                                ...
                                aoColumnDefs: [
                                    ...
                                    {
                                        "visible": ($('#Ubicacion').prop('checked')) ? true : false,
                                        "aTargets": [14]
                                    },
                                    {
                                        "visible": ($('#SemanaSalidaD').prop('checked')) ? true : false,
                                        "aTargets": [15]
                                    },
            ...
            let ReporteDinamicoEntr = $("#btnEntradasDinamico").click(function (event) {
                ...
                if (FechaInicial === '' || FechaFinal === '') {
                    ...
                    $.ajax({
                        ...
                        url: '/Laboratorio/Reportes/ReporteEntradaDinamico/' + FechaInicial + '/' + FechaFinal + '/' + IDVariedad + '/Get',
                        type: 'get',
                        ...
                        success: function (Result) {
                            ...
                            $('#ReporteDinamicoDespuntes').hide();
                            $('#ReporteDinamicoSalidasFecha').hide();
                            $('#ReporteDinamicoEntradasFecha').hide();
                            $('#ReporteDinamicoEntradasFechaN').hide();
            ...
            let ReporteDinamicoSalida = $("#btnSalidasDinamico").click(function (event) {
                event.preventDefault();
                ...
                if (FechaInicial === '' || FechaFinal === '') {
                    ...
                    $.ajax({
                        data: {FechaInicial: FechaInicial, FechaFinal: FechaFinal, IDVariedad: IDVariedad},
                        url: '/Laboratorio/Reportes/ReporteSalidaDinamico/' + FechaInicial + '/' + FechaFinal + '/' + IDVariedad + '/Get',
                        type: 'get',

                        success: function (Result) {
                            $("#ReporteDinamicoSalidas").pivotUI(Result.data,
                                {renderers: renderers},
                                false, "es"
                            );
                            $('#loading').hide();
                            ...
                            $('#ReporteDinamicoEntradasFechaN').hide();
                            $('#ReporteDinamicoEntradasFecha').hide();
                            $('#ReporteDinamicoSalidas').show();
                        },
                    });
                }
            });

            let ReporteDinamicDespunte = $("#btnDespunteDinamico").click(function (event) {
                event.preventDefault();
                ...
                if (FechaInicial === '' || FechaFinal === '') {
                    ...
                    $.ajax({
                        data: {FechaInicial: FechaInicial, FechaFinal: FechaFinal, IDVariedad: IDVariedad},
                        url: '/Laboratorio/Reportes/ReporteDespunteDinamico/' + FechaInicial + '/' + FechaFinal + '/' + IDVariedad + '/Get',
                        type: 'get',

                        success: function (Result) {
                            $("#ReporteDinamicoDespuntes").pivotUI(Result.data,
                                {renderers: renderers},
                                false, "es"
                            );
                            $('#loading').hide();
                            ...
                            $('#ReporteDinamicoEntradasFecha').hide();
                            $('#ReporteDinamicoEntradasFechaN').hide();
                            $('#ReporteDinamicoDespuntes').show();
                        },
                    });
                }
            });

            let ReporteDinamicoEntrF = $("#btnEntradasDinamicoFecha").click(function (event) {
                event.preventDefault();
                ...
                if (FechaInicial === '' || FechaFinal === '') {
                    ...
                    function changeNumber() {
                        $.ajax({
                            ...
                            url: '/Laboratorio/Reportes/ReporteEntradaDinamicoFecha/' + FechaInicial + '/' + FechaFinal + '/Get',
                            type: 'get',

                            success: function (Result) {
                                $("#ReporteDinamicoEntradasFecha").pivotUI(Result.data,
                                    {renderers: renderers},
                                    false, "es"
                                );
                                $('#loading').hide();
                                ...
                                $('#ReporteDinamicoEntradas').hide();
                                $('#ReporteDinamicoEntradasFechaN').hide();
                                $('#ReporteDinamicoEntradasFecha').show();
                            },
                        });
                    }

                    setInterval(changeNumber, 10000);
                }
            });

            let ReporteDinamicoEnt = $("#btnEntradasDinamicoFechaN").click(function (event) {
                event.preventDefault();
                ...
                if (FechaInicial === '' || FechaFinal === '') {
                    ...
                    $.ajax({
                        ...
                        success: function (Result) {
                            $("#ReporteDinamicoEntradasFechaN").pivotUI(Result.data,
                                {renderers: renderers},
                                false, "es"
                            );
                            $('#loading').hide();
                            ...
                            $('#ReporteDinamicoEntradas').hide();
                            $('#ReporteDinamicoEntradasFecha').hide();
                            $('#ReporteDinamicoEntradasFechaN').show();
                        },
                    });
            ...
            let ReporteDinamicoSaliF = $("#btnSalidasDinamicoFecha").click(function (event) {
                event.preventDefault();
                ...
                if (FechaInicial === '' || FechaFinal === '') {
                    ...
                    $.ajax({
                        data: {FechaInicial: FechaInicial, FechaFinal: FechaFinal},
                        url: '/Laboratorio/Reportes/ReporteSalidaDinamicoFecha/' + FechaInicial + '/' + FechaFinal + '/Get',
                        type: 'get',

                        success: function (Result) {
                            $("#ReporteDinamicoSalidasFecha").pivotUI(Result.data,
                                {renderers: renderers},
                                false, "es"
                            );
                            $('#loading').hide();
                            ...
                            $('#ReporteDinamicoDespuntes').hide();
                            $('#ReporteDinamicoEntradasFecha').hide();
                            $('#ReporteDinamicoSalidasFecha').show();
                            $('#ReporteDinamicoEntradas').hide();
                            $('#ReporteDinamicoEntradasFechaN').hide();
                        },
                    });
