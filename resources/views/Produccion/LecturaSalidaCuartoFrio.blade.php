...
@section('contenidoPrincipal')
    ...
    <div class="card row">
        ...
        <form id="LecturaSalidaFrio" method="get" action="{{ route('VistaLecturaSalidaCuarto') }}">
                ...
                <div class="form-row text-center">
                    <div class="col-lg-4">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" aria-label="Recipient's username" name="CodigoBarrasCajahn" aria-describedby="basic-addon2">
                            <div class="input-group-append">
                                <button class="btn btn-outline-secondary" aria-hidden="true" type="button">
    ...
    <script>
        ...
        $('#LecturaSalidaFrio').submit(function (event) {
            event.preventDefault();
            let DatosEviados = $('#LecturaSalidaFrio').serialize();//paso todos los datos del for a una variable
            ...
            if (barcode.length === 9) { //valido ancho tanto minimo como maximo
                ...
                $.ajax({
                    ...
                    url: '{{ route('LecturaSalidaCuarto') }}',//ruto post
                    type: 'post',
