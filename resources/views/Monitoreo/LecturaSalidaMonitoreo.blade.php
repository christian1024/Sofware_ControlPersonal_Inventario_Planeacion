...
@section('contenidoPrincipal')
    ...
    <div class="card row">
        <div class="col-lg-12">
            <h3>Lectura Salida Monitoreo</h3>
        </div>

        <div class="card border-secondary text-center">

            <div class="card-body">
                <form id="ViewLecturaSalidaMonitoreo" method="get" action="{{ route('ViewLecturaSalidaMonitoreo') }}">
    ...
    <script>
        ...
        $('#ViewLecturaSalidaMonitoreo').submit(function (event) {
            event.preventDefault();
            let DatosEviados = $('#ViewLecturaSalidaMonitoreo').serialize();//paso todos los datos del for a una variable
            ...
            if (barcode.length === 9) { //valido ancho tanto minimo como maximo
                ...
                $.ajax({
                    ...
                    url: '{{ route('LecturaSalidaMonitoreo') }}',//ruto post
                    type: 'post',
