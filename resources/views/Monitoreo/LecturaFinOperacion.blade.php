...
@section('contenidoPrincipal')
    ...
    <div class="card row">
        <div class="col-lg-12">
            <h3>Lectura Salida Empleado</h3>
        </div>

        <div class="card border-secondary text-center">

            <div class="card-body">
                <form id="ViewLecturaFinCuartoOperario" method="get" action="{{ route('ViewLecturaFinCuartoOperario') }}">
    ...
    <script>
        ...
        $('#ViewLecturaFinCuartoOperario').submit(function (event) {
            event.preventDefault();
            let DatosEviados = $('#ViewLecturaFinCuartoOperario').serialize();//paso todos los datos del for a una variable
            ...
            if (CodOperario.length >= 3) { //valido ancho tanto minimo como maximo
                $.ajax({
                    ...
                    url: '{{ route('LecturaFinCuartoOperario') }}',//ruto post
                    type: 'post',
