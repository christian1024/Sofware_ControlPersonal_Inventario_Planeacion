...
@section('contenidoPrincipal')
    ...
    <div class="card row">
        <div class="col-lg-12">
            <h3>Lectura Entrada Cuarto</h3>
        </div>

        <div class="card border-secondary text-center">

            <div class="card-body">
                <form id="ViewLecturaEntradaCuarto" method="get" action="{{ route('ViewLecturaEntradaCuarto') }}">
    ...
    <script>
        ...
        $('#ViewLecturaEntradaCuarto').submit(function (event) {
            event.preventDefault();
            let DatosEviados = $('#ViewLecturaEntradaCuarto').serialize();//paso todos los datos del for a una variable
            ...
            if (barcode.length === 9) { //valido ancho tanto minimo como maximo
                ...
                $.ajax({
                    ...
                    url: '{{ route('LecturaEntradaCuartoMonitoreo') }}',//ruto post
                    type: 'post',
                    success: function (Result) {
                        ...
                        if (Result.data === 1) {
                            ...
                            $('#VarLei').val(Result.consulta.Nombre_Variedad);
                            $('#count').val(cout);
                            $('#Barcode').val('').focus();
                            $('#ErrorDiv').hide();
