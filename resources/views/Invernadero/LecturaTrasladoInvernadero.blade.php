...
@section('contenidoPrincipal')
    ...
    <div class="card row">
        <div class="col-lg-12">
            <h3>Lectura Traslado Inv</h3>
        </div>
        <form id="LecturaEntradaInvernadero" method="get" action="{{ route('VistaLecturaTrasladoInvernadero') }}">
        ...
        $('#LecturaEntradaInvernadero').submit(function (event) {
            ...
            if (barcode.length === 9) { //valido ancho tanto minimo como maximo
                ...
                $.ajax({
                    ...
                    url: '{{ route('LecturatrasladoInvernadero') }}',//ruto post
                    type: 'post',
                    success: function (Result) {
                        //console.log(Result);
                        if (Result.data === 1) {
