...
@section('contenidoPrincipal')
    <div class="card row">
        <div class="col-lg-12">
            <h3>Lectura Descarte Inv</h3>
        </div>
        <form id="LecturaEntradaInvernadero" method="get" action="{{ route('VistaLecturaEntradaInvernadero') }}">
            ...
            <div class="box box-body col-lg-12">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-lg-4 ">
                        ...
                        <input type="text" class="labelform form-control" autocomplete="off" id="PlantasDescarte" required name="PlantasDescarte">
                    </div>
        ...
        $('#LecturaEntradaInvernadero').submit(function (event) {
            ...
            if (barcode.length === 9) { //valido ancho tanto minimo como maximo
                ...
                $.ajax({
                    ...
                    url: '{{ route('LecturaDescarteInvernadero') }}',//ruto post
                    type: 'post',
                    success: function (Result) {
                        //console.log(Result);
                        if (Result.data === 1) {
