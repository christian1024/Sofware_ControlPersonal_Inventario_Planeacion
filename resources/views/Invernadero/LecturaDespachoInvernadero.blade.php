...
@section('contenidoPrincipal')
    <div class="card row">
        <div class="col-lg-12">
            <h3>Lectura Despacho</h3>
        </div>
        <form id="LecturaDespachoInvernadero" method="get" action="{{ route('VistaLecturaDespachoInvernadero') }}">
    ...
    <script>
        ...
        $('#LecturaDespachoInvernadero').submit(function (event) {
            event.preventDefault();
            let DatosEviados = $('#LecturaDespachoInvernadero').serialize();//paso todos los datos del for a una variable
            ...
            if (barcode.length === 9) { //valido ancho tanto minimo como maximo
                ...
                $.ajax({
                    ...
                    url: '{{ route('LecturaDepachoInvernadero') }}',//ruto post
                    type: 'post',
