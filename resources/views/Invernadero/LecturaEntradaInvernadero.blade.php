                    ...
                    <div class="form-row">
                        <div class="form-group col-lg-6">
                            ...
                            <select class="labelform form-control" required id="IDCama" name="IDCama">
                                ...
                                @foreach( $camas as $cama)
                                    <option value=" {{ $cama->id }}"> {{ __('Banco') }} {{ $cama->N_Cama }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <select class="labelform form-control" required id="idValvula" name="idValvula">
                                <option value="">Seleccione Valvula</option>
                            </select>
                        </div>
                    </div>
            ...
            if (barcode.length === 9) { //valido ancho tanto minimo como maximo
                if (Operario.length === 4) {
                    ...
                    $.ajax({
                        ...
                        url: '{{ route('LecturaEntradaInvernadero') }}',//ruto post
                        type: 'post',
                        success: function (Result) {
                            //console.log(Result);
                            if (Result.data === 1) {
