...
@section('contenidoPrincipal')
    <div class="card row">
        <div class="col-lg-12">
            <h3>Lectura Salida Alistamiento</h3>
        </div>
        <form id="LecturaAlistamientoDespachoInvernadero" method="get" action="{{ route('VistaLecturaSalidaAlistamientoDespachoInvernadero') }}">
        ...
        $('#LecturaAlistamientoDespachoInvernadero').submit(function (event) {
            ...
            if (barcode.length === 9) { //valido ancho tanto minimo como maximo
                ...
                $.ajax({
                    ...
                    url: '{{ route('LecturaSalidaAlistamientoDepachoInvernadero') }}',//ruto post
                    type: 'post',
