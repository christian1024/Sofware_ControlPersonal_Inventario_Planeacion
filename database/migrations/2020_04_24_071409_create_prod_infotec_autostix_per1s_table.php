...
class CreateProdInfotecAutostixPer1sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('prod_infotec_autostix_per1s', function (Blueprint $table) {
            $table->Increments('id');
    ...
    {
        Schema::dropIfExists('prod_infotec_autostix_per1s');
    }
}
